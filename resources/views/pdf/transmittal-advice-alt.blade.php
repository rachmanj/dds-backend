    ...
    <div class="wrapper">
        ...
        <section class="invoice">
                ...
                <div class="col-12">
                    <table class="table">
                        <tr>
                            ...
                            <td rowspan="2">
                                <h3><b>Surat Pengiriman Invoice</b></h3>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <p>
                    <h5>Date: {{ date('d-M-Y', strtotime($spi->date)) }}</h5>
                    </p>
                        ...
                        <tbody>
                            @foreach ($spi->invoices as $invoice)
                                <tr>
                                    ...
                                    <th class="text-right">{{ $invoice->inv_currency }}
                                        {{ number_format($invoice->inv_nominal, 0) }}</th>
